            ...
            <div class="main">
                    <div class="kiri">
                        ...
                        <form method="post" action="/save">
                            ...
                            <input type="email" name="email" value="{{$data[0]->USER_EMAIL}}" disabled /><br/>
                            <label>Nama</label><br/>
                            <input type="text" name="nama" value="{{$data[0]->USER_NAME}}"/><br/>
                            <label>No Telp</label><br/>
                            <input type="tel" id="phone" name="telp" pattern="[0-9]{4}[0-9]{4}[0-9]{4}" value="0{{$data[0]->USER_TELP}}"/><br/>
