            ...
            <div class="kanan">
                ...
                <div class="right">
                    <div class="isi2">
                        ...
                        {{$passanger}} Passanger &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;   :  {{($posts[0]->RUTE_PRICE)*$passanger}}<br/>
                        Tax (10%) &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;   : {{($posts[0]->RUTE_PRICE)*$passanger/10}}
                        <div class="total">
                            Total :<br/>
                            <div class="bold"> Rp {{number_format(((($posts[0]->RUTE_PRICE)*$passanger)+(($posts[0]->RUTE_PRICE)*$passanger/10)),2,',','.')}}</div>
                        </div>
                        <form action="/insert/{{$posts[0]->RUTE_ID}}/{{$date}}/{{((($posts[0]->RUTE_PRICE)*$passanger)+(($posts[0]->RUTE_PRICE)*$passanger/10))}}/{{serialize($nama)}}/{{serialize($id)}}" method="post">
                            @csrf
